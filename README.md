...
This is the code repository for the [Angular Resource Calendar (Open-Source)](https://code.daypilot.org/42642/angular-resource-calendar-tutorial) tutorial by [DayPilot](https://www.daypilot.org/).
